...
SEND_WAVES_DESCRIPTION = f'Следующее задание не для жадных. Отправь 0.1 WAVES на адрес: {APP_WAVES_ADDRESS}'
...
FIND_USER_DESCRIPTION = 'Найди этого человека, возьми его адрес и отправь его мне. А потом мы вернемся к нашему разговору.'
